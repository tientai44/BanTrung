...
public class G4_UICanvas : MonoBehaviour
{
    ...
    {
        G4_UIManager.GetInstance().AddBackUI(this);
        G4_UIManager.GetInstance().PushBackAction(this, BackKey);
    }
    ...
    {
        G4_UIManager.GetInstance().RemoveBackUI(this);
